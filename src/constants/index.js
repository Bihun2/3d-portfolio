...
const counterItems = [
  ...
  { value: 6, suffix: "+", label: "Programming Languages Learned" },
];
...
const expCards = [
  {
    ...
    responsibilities: [
      "Developed and update fullstack applications with React, Angular, NodeJS and PostgreSQL.",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Implemented multi-language support for web applications using XML",
    ],
  },
];
